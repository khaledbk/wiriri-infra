...
|-----|-----------|-----------|------|--------------|
| wiriri-prod-web-01 | 102.207.250.149 | 10.130.18.3 | nginx edge + webapp + admin | 80, 443 |
| wiriri-prod-api-01 | 102.207.250.152 | 10.130.18.4 | NestJS backend :4001 + Redis | 22 only |
| wiriri-prod-db-01 | 102.207.250.154 | 10.130.18.5 | PostgreSQL :5432 | 22 only |
| wiriri-prod-monitor-01 | 102.207.250.159 | 10.130.18.6 | Prometheus + Grafana | (per fw) |
| wiriri-prod-storage-01 | 102.207.250.162 | 10.130.18.7 | MinIO :9000/:9001 (+ imgproxy :8080 NEW) | 22 only |
...
| web-01 (.3) | storage-01 (.7) | 8080 | cdn `/img/` → imgproxy | ⚠️ **ADD** |
...
| monitor-01 (.6) | all | 9100/9121 | scrape exporters | VPC |
